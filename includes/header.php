...
<body>
    <nav class="main-nav">
        <div class="logo">
            <a href="index.php">PlaylistHub</a>
        </div>
        <ul>
            <li><a href="index.php" class="<?= ($current_page == 'index.php') ? 'active' : '' ?>">Home</a></li>
            <li><a href="artists.php" class="<?= ($current_page == 'artists.php') ? 'active' : '' ?>">Artists</a></li>
            <li><a href="albums.php" class="<?= ($current_page == 'albums.php') ? 'active' : '' ?>">Albums</a></li>
            <li><a href="playlists.php" class="<?= ($current_page == 'playlists.php' || $current_page == 'create_playlist.php' || $current_page == 'edit_playlist.php' || $current_page == 'view_playlist.php') ? 'active' : '' ?>">Playlists</a></li>
        </ul>
    </nav>
    <div class="container">